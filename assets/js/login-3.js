...
var KTLogin = (function () {
    ...
    FormValidation.formValidation(form, {
      fields: {
        email: {
          validators: {
            notEmpty: {
              message: "Surel (Email) tidak boleh kosong",
            },
            emailAddress: {
              message: "Masukkan surel (Email) yang valid",
            },
          },
        },
        password: {
    ...
    FormValidation.formValidation(form, {
      fields: {
        email: {
          validators: {
            notEmpty: {
              message: "Surel (Email) harus diisi",
            },
            emailAddress: {
              message: "Masukkan Surel (Email) yang valid",
            },
  ...
  var _handleFormSignup = function () {
      ...
      if (validator) {
        validator.validate().then(function (status) {
          if (status == "Valid") {
            ...
            Swal.fire({
              text: "Isi semua data untuk melanjutkan",
              icon: "error",
              buttonsStyling: false,
              confirmButtonText: "Oke",
              customClass: {
    ...
    wizardObj.on("submit", function (wizard) {
      Swal.fire({
        text: "Apakah anda yakin dengan data yang telah anda masukkan adalah BENAR?",
        icon: "success",
